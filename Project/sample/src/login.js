...
function Login(){
    ...
    function validate()
    {
        ...
        var url = "http://localhost:4000/login/signin";
    ...
    function register(){
        ...
        var url = "http://localhost:4000/registration/signup";
        var data = JSON.stringify({
            firstname : RT1.value,
            lastname : RT2.value,
            contactno : RT3.value,
    ...
    return(
        <div className='full-height'>
            <div id='header' className='loginheader'>QuickShopHub</div>
            ...
            <div id='footer' className='loginfooter'>Copyright @ Team Coders. All rights reserved.</div>
        </div>
    );
}
