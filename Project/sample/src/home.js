...
import './home.css'
import logouticon from './images/th.jpeg'
import { callApi, errorResponse, getSession, setSession } from './main';
import menuicon from './images/th (2).jpg'
...
export function showSMenu(mid){
    var surl = "http://localhost:4000/home/menus"; 
...
export function loadModule(smid) {
    ...
    switch (smid) {
        case "M00102":
            module.src = "/addproducts";
            titlebar.innerText = "Product Management";
            break;
    }
}
...
class Home extends React.Component
{
    constructor()
    {
        ...
        var url = "http://localhost:4000/home/uname";
        var data = JSON.stringify({
            emailid : this.sid
        });
        callApi("POST", url, data, this.loadUname, errorResponse);

        url = "http://localhost:4000/home/menu";
        ...
        return(
            <div className='full-height'>
                <div className='header'>
                    <label style={HS1}> QuickShopHub | Supply Chain Management System</label>
                ...
                <div className='footer'>
                    Copyright @ Team Coders. All rights reserved.
                </div>
            </div>
        );
    }
